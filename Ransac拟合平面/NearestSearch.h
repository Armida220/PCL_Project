...
public:
	...
	*************************************************/
	...
	Others:         // 其它说明
	*************************************************/
    int nearestRSearch(new3s_PointXYZ &query_point , float radius , std::vector<new3s_PointXYZ> &indice_points , std::vector<float> &distance) ;

    int nearestRSearch(new3s_PointXYZ &query_point , float radius , std::vector<int> &indices , std::vector<float> &distance) ;
